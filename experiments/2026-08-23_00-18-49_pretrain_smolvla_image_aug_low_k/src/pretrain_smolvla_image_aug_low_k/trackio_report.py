    ...
    try:
        ...
        payload: dict[str, Any] = {
            ...
            "reports/summary": trackio.Markdown(
                ...
                "Full-FT adaptations with lerobot's default training-time image "
                "transforms enabled (photometric jitter + small random affine); "
                "otherwise identical to the full-FT experiment. Each checkpoint is "
                "evaluated (no augmentation) at inference n_action_steps=50 and 25. "
