...
EXPERIMENT_NAME = "pretrain_smolvla_full_ft_low_k"
TRACKIO_PROJECT = "pretrain-smolvla-full-ft-low-k"
CREATED_AT = "2026-08-22T18:10:40+03:00"
...
# (2026-08-21_20-37-56_pretrain_smolvla_low_k_deterministic_repro): the whole
# policy is fine-tuned.  The VLM text tower and the vision encoder unfreeze;
# LeRobot's SmolVLA implementation still keeps its unused-by-design tensors
# frozen (vlm.lm_head, the final text_model.norm, the last retained VLM text
# layer, and the expert's lm_head) as a distributed-training guard.
...
OUTPUT_ROOT = Path(
    "/var/tmp/vla_outputs/full_ft_low_k_20260822_181040"
)
