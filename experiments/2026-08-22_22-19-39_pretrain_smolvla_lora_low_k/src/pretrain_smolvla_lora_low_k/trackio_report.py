    ...
    try:
        ...
        payload: dict[str, Any] = {
            ...
            "reports/summary": trackio.Markdown(
                ...
                "LoRA-on-VLM adaptations (r=16 adapters on VLM linears; expert and "
                "projections fully trained, merged before eval) from the frozen "
                "pretrain; demos are the official demo_0..demo_{k-1}. Each "
