...
export TRACKIO_PROJECT="${TRACKIO_PROJECT:-pretrain-smolvla-prompt-only-2}"
...
export VLA_CHECKPOINT_PATH="/var/tmp/vla_outputs/seen_libero90_official_20260817/checkpoints/030000/pretrained_model"
