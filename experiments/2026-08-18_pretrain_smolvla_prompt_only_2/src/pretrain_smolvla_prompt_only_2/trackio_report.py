...
DEFAULT_PROJECT = TRACKIO_PROJECT
DEFAULT_RUN_NAME = "2026-08-18-pretrain-prompt-only"
...
def log_to_trackio(
    ...
    init_args: dict[str, Any] = {
        ...
        "config": {
            ...
            "checkpoint_sha256": summary["checkpoint"]["model_safetensors_sha256"],
            **CHECKPOINT_PROVENANCE,
            "seed": MASTER_SEED,
    ...
    try:
        ...
        payload: dict[str, Any] = {
            ...
            "reports/summary": trackio.Markdown(
                "# Official-pretrain SmolVLA prompt-only\n\n"
                "Frozen official-data LIBERO-90 checkpoint (30k DDP steps, seen "
                "positive control 20/20), zero target demonstrations, zero optimizer "
                "steps, all ten libero_goal tasks. The table reports true, wrong-task, "
                "and nonsense-prompt controls."
            ),
        }
        for item in gifs:
