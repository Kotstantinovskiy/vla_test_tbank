...
EXPERIMENT_NAME = "pretrain_smolvla_naive_baseline_few_shot_tune"
TRACKIO_PROJECT = "pretrain-few-shot-tune"
DATE = "2026-08-18"
...
OUTPUT_ROOT = Path("/var/tmp/vla_outputs/pretrain_few_shot_tune_20260818")
