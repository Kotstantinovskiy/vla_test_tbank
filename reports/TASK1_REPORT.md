...
![Baseline cost curve](generated/cost_curve.png)
...
`scripts/`, сырые rollout JSON — в `results/`, а агрегированные JSON/CSV/PNG —
в `reports/generated/`. Проверка кода: `pytest -q` (4 теста), `compileall` и
`git diff --check`.
